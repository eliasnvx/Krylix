...
public class HudRender {
    public static void rounded(GuiGraphics guiGraphics, int x, int y, int size, int cornerCut, Runnable paint) {
        rounded(guiGraphics, x, y, size, size, cornerCut, paint);
    }

    public static void rounded(GuiGraphics guiGraphics, int x, int y, int width, int height, int cornerCut, Runnable paint) {
